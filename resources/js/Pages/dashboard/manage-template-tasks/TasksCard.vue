        ...
        <div class="flex justify-between font-medium">
          <div class="">
            ...
            <div class="text-sm text-brand-500">
                ...
                <span class="inline">{{ row.task_status.name }} | {{ moment(row.task_status_at).format('MM/DD/YY hh:mm A') }}</span>
            </div>
...
import { TicketIcon, UserCircleIcon, QuestionMarkCircleIcon } from '@heroicons/vue/24/solid'
