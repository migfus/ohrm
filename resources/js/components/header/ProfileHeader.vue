<template>
  <div>
    ...
    <RemovalPrompt v-model="open_remove" @confirm="removeUser()"/>
    <UploadAvatarModal v-model="avatar" v-model:show="open_avatar" @upload="upload('avatar')" name="Upload Avatar" :ratio="1" :size="[400, 400]"/>
    <UploadAvatarModal v-model="cover" v-model:show="open_cover" @upload="upload('cover')" name="Upload Cover" :ratio="639/95" :size="[1278*4, 190*4]"/>
  </div>
</template>
